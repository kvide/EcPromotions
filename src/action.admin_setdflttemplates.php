...
$this->SetCurrentTab('dflt_templates');

if (isset($params['submit_coupoonformtemplate']))
{
    $this->SetPreference(\EcPromotions::NEWCOUPONFORM_TEMPLATE, trim($params['input_couponformtemplate']));
}
else if (isset($params['reset_couponformtemplate']))
{
    $fn = dirname(__FILE__) . '/templates/orig_couponform_template.tpl';
    if (file_exists($fn))
    {
