...
$sqlarray = $dict->DropTableSQL(\EcPromotions\PROMOTIONS_TABLE);
$dict->ExecuteSQLArray($sqlarray);

$sqlarray = $dict->DropTableSQL(\EcPromotions\PROMOTIONS_COND_TABLE);
$dict->ExecuteSQLArray($sqlarray);

$this->DeleteTemplate();
$this->RemovePreference();
$this->RemovePermission(\EcPromotions::MAIN_PERM);
