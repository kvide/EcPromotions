...
class promotion_assistant implements \EcommerceExt\Promotion\promotion_assistant
{

    private $_mod;

    public function __construct(\EcPromotions $mod)
    {
        $this->_mod = $mod;
    }
    ...
    public function get_test_object()
    {
        $ob = new promotion_tester();
        return $ob;
    }
