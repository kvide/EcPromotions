...
echo $this->ShowTemplateList($id, $returnid, 'couponform_', \EcPromotions::NEWCOUPONFORM_TEMPLATE, 'couponform',
                                \EcPromotions::DFLTCOUPONFORM_TEMPLATE, $this->Lang('couponformtemplate_addedit'));
